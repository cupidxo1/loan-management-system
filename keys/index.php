...
<head>
    ...
    <title>Sudent Loan Management System</title>
...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<a class="navbar-brand" href="">Student Loan Management System</a>
	</nav>
    <div class="container">
			...
			<div class="col-xl-10 col-lg-12 col-md-9">
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block"><img src="image/CentralUniversity-logo.jpg" height="100%" width="100%"/></div>
                            <div class="col-lg-6">
                                <div class="p-5">
	...
	<nav class="navbar fixed-bottom navbar-dark bg-dark">
		<label style="color:#ffffff;">&copy;Student Loan Management System</label>
